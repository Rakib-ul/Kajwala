            ...
            <div class="user-menu">
                ...
                <a href="{{ url('/profile') }}" class="user-avatar-link"> <!-- Added anchor tag -->
                    <div class="user-avatar">
                        ...
                        @else
                            <img src="https://ui-avatars.com/api/?name={{ urlencode(auth()->user()->name) }}&background=5a67d8&color=fff"
                                alt="User Avatar">
                        @endif
                    </div>
                </a>
            ...
            <div class="user-profile">
                <div class="user-avatar-large">
                    @if (auth()->user()->profile_picture)
                        <img src="{{ asset(auth()->user()->profile_picture) }}" alt="User Avatar">
                    @else
                        <img src="https://ui-avatars.com/api/?name={{ urlencode(auth()->user()->name) }}&background=5a67d8&color=fff&size=100"
                            alt="User Avatar">
                    @endif
                </div>
        ...
        <div class="container">
            <div class="footer-content">
                <div class="footer-column">
                    <h3>KaajWala</h3>
                    <p>Your trusted partner for all home and office service needs. We connect you with skilled
                        professionals for any task.</p>
